...
(function (global, factory) {
  ...
  var DOMIterator = /*#__PURE__*/function () {
    ...
    return _createClass(DOMIterator, [{
      key: "getContexts",
      ...
      value: function observeIframeLoad(ifr, successFn, errorFn) {
        ...
        var _listener = function listener() {
          ...
          try {
            if (!_this.isIframeBlank(ifr)) {
              ifr.removeEventListener('load', _listener);
        ...
        ifr.addEventListener('load', _listener);
        tout = setTimeout(_listener, this.iframesTimeout);
      }
    }, {
      key: "onIframeReady",
  ...
  var RegExpCreator = /*#__PURE__*/function () {
    ...
    return _createClass(RegExpCreator, [{
      key: "create",
      ...
      value: function createAccuracyRegExp(str) {
        ...
        switch (val) {
          ...
          case 'exactly':
            return "(^|\\s|\\b".concat(lsJoin, ")(").concat(str, ")(?=$|\\s").concat(lsJoin, ")");
        }
      }
    }]);
  }();
          ...
          _handler = function handler(kw) {
            ...
            _this9[fn](regex, 1, function (term, node) {
              ...
              if (kwArr[kwArrLen - 1] === kw) {
                ...
                _handler(kwArr[kwArr.indexOf(kw) + 1]);
              }
            });
          };
        if (this.opt.acrossElements) {
